                ...
                colors.map((color, index) => {
                    if (color.name === avaliableModels){
                        ...
                        return (
                            ...
                            <p
                            className={`rounded-full bg-[${color.hex}] ring-1 ring-gray-900/35 block min-w-5 min-h-5 hover:scale-110 hover:ring-blue-500/50 hover:ring-2 transition-all duration-300 delay-200`}
                            >
                            </p>
                        </div>
                    )
